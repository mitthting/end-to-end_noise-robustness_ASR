...
class DBiRNN(object):
    ...
    def build_graph(self, args, maxTimeSteps):
        ...
        with self.graph.as_default():
            ...
            # self.inputList = tf.split(0, maxTimeSteps, inputXrs) #convert inputXrs from [16*maxL,39] to [16,maxL,39]
            #self.inputList = tf.split(inputXrs, maxTimeSteps, 0)  # convert inputXrs from [16*maxL,39] to [16,maxL,39]
            ...
            #self.predictions = tf.to_int32(tf.nn.ctc_beam_search_decoder(logits3d, self.seqLengths, merge_repeated=True, beam_width=14, top_paths=5)[0][0])
