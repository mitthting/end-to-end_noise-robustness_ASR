...
@describe
def logging(model,logfile,errorRate,ctcloss,epoch=0,delta_time=0,mode='train'):
    ...
    if mode == 'config':
        ...
        with open(logfile, "a") as myfile:
            ...
            myfile.write("Epoch:"+str(epoch+1)+' '+"train error rate: "+str(errorRate)+' , '+"CTC loss: "+str(ctcloss)+'\n')
